...
class CounterBloc {
  ...
  StreamController _input1Controller = StreamController();
  StreamSink get inputan1 => _input1Controller.sink;

  StreamController _output1Controller = StreamController();
  StreamSink get _sinkOut1 => _output1Controller.sink;

  StreamController _input2Controller = StreamController();
  StreamSink get inputan2 => _input2Controller.sink;

  StreamController _output2Controller = StreamController();
  StreamSink get _sinkOut2 => _output2Controller.sink;

  StreamController _input3Controller = StreamController();
  StreamSink get inputan3 => _input3Controller.sink;

  StreamController _output3Controller = StreamController();
