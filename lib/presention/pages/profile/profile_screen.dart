                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child : Text(
                                            'John Doe', style: TextStyle(fontSize: 22),
                                          ),
                                        ),
                                        Padding(
                                                  ...
                                                  child : Row(
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child : Text(
                                                          'Jakarta', style: TextStyle(fontSize: 14),
                                                        ),
                                                      ),
                                                    ],
                                                  ),
                                                  ...
                                                  child : Row(
                                                    children: [
                                                      ...
                                                      Padding(
                                                        padding : const EdgeInsets.only(left: 11),
                                                        child : Text(
                                                          '081234567890', style: TextStyle(fontSize: 14),
                                                        ),
                                                      ),
                                                    ],
                                                  ),
                                                  ...
                                                  child : Row(
                                                    children: [
                                                      ...
                                                      Padding(
                                                        padding : const EdgeInsets.only(left: 11),
                                                        child : Text(
                                                          'Example@gmail.com', style: TextStyle(fontSize: 14),
                                                        ),
                                                      ),
                                                    ],
                                                  ),
                                      ...
                                      child: Row(
                                        children: [
                                          Padding(
                                            padding : const EdgeInsets.only(left: 9),
                                            child : Text(
                                              'Saldo Anda :', style: TextStyle(fontSize: 22),
                                            ),
                                          ),
                                          Padding(
                                            padding : const EdgeInsets.only(left: 8),
                                            child : Text(
                                              'Rp. 0', style: TextStyle(fontSize: 22, color: Color(0xFF019BF1)),
                                            ),
                                          ),
                                          Padding(
